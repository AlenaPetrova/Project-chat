        ...
        private void processData(Message message)
        {
            switch (message.Head)
            {
                case Message.Header.REGISTER:
                    ...
                    {
                        Console.WriteLine("- Регистрация прошла успешно: " + User.Login);
                    }
                    else
                    {
                        Console.WriteLine("- Ошибка регистрации: " + User.Login);
                    }
                    break;
                ...
                case Message.Header.JOIN:
                    ...
                    {
                        Logged = true;
                        Console.WriteLine("- Подключение прошло успешно: " + User.Login);
                    }
                    else
                    {
                        Logged = false;
                        Console.WriteLine("- Ошибка подключения: " + User.Login);
                    }
                    break;
                ...
                case Message.Header.JOIN_CR:
                    if (message.MessageList[0] == "success")
                    {
                        ...
                        Console.WriteLine("- Подключился(-лась) к беседе: " + message.MessageList[1]);
                    }
                    else
                    {
                        Console.WriteLine("- Не смог(-ла) подключиться к беседе: " + message.MessageList[1]);
                    }
                    break;
                ...
                case Message.Header.QUIT_CR:
                    ...
                    {
                        User.Chatroom = null;
                        Console.WriteLine("- Отключился(-лась) от беседы: " + message.MessageList[1]);
                    }
                    else
                    {
                        Console.WriteLine("- Не смог(-ла) отключиться от беседы: " + message.MessageList[1]);
                    }
                    break;
                ...
                case Message.Header.CREATE_CR:
                    if (message.MessageList[0] == "success")
                    {
                        ...
                        Console.WriteLine("- Беседа создана: " + message.MessageList[1]);
                    }
                    else
                    {
                        Console.WriteLine("- Беседа не создана: " + message.MessageList[1]);
                    }
                    break;
